    ...
    <ul class="navbar-nav">
      ...
      <li class="sidenav nav-item ">
        ...
        <div class="dropdown-container">
          ...
          <a class="dropdown-item" style="margin-left: 31px;" href="{{ route('illness_categories.index') }}">Illness
            Data</a>
          <a class="dropdown-item" style="margin-left: 31px;" href="{{ route('indications.index') }}">Indication
            Data</a>
      ...
      <li class="nav-item">
        <a class="nav-link   @if (Route::is('basic_data') )  active @endif" href="{{ route('basic_data') }}">
          ...
          <span class="nav-link-text ms-1">Basic Data</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link  @if (Route::is('drugs.index') )  active @endif" href="{{ route('drugs.index') }}">
          ...
          <span class="nav-link-text ms-1">Drug</span>
        </a>
      </li>
      <li class="sidenav nav-item ">
        <a class="dropdown-btn"><i class="fa fa-list-alt"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
            class="nav-link-text ms-1">Logically Algorithmes</span>
          <i class="fa fa-caret-down"></i>
        </a>
        <div class="dropdown-container">
          <a class="dropdown-item" style="margin-left: 31px;" href="{{ route('hx_drugs.index') }}">Recheck Drug</a>
          <a class="dropdown-item" style="margin-left: 31px;" href="{{ route('forbidden_cases.index') }}">Forbidden case</a>
        </div>
      </li>
