                     ...
                     <form action="{{route('forbidden_cases.update', $forbidden_case->id)}}" method="post"
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col">
                                    <input type="text" class="form-control" value="{{ $values->age->name }}"
                                       disabled /><br>
                                 </div>
                              </div>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col">
                                    <input type="text" class="form-control" value="{{ $values->gender->name }}"
                                       disabled /><br>
                                 </div>
                              </div>
                              ...
                              @elseif ($values->value == "1" && $values->variableable_type ==
                              'App\Models\PregnancyStage')
                              <div class="row">
                                 <div class="col">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col">
                                    <input type="text" class="form-control"
                                       value="{{ $values->indication->indication_title }}" disabled /><br>
                                 </div>
                              </div>
                              @endif
                              @endforeach
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              ...
                              @elseif ($values->value == "2" && $values->variableable_type ==
                              'App\Models\PregnancyStage')
                              <div class="row">
                                 <div class="col">
                                    <input type="text" class="form-control" value="Pregnancy Stage" disabled /><br>
