...
class AlgorithmController extends Controller
{
    ...
    {
        $dose =null; 
        $dose_and = NoteDose::with('doseMessage','effect','noteDoseVariables')->where('variable_id',$variableId)->where('effect_id',$effectId)->where('dose_type_id',2)->orderBy('priority')->get();
