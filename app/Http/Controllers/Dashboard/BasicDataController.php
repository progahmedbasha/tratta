...
class BasicDataController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.basic-data.basic-data', compact('categories','parent_categories','category_subs','illness_categories','category_illness_subs','genders','ages','weights','weight_genders','pregnancy_stages','pregnancy_safties','nursing_safties_categories',
